市況かぶ全力2階建さん 登場者ランキング2016
====================

【Update!】2016年に対応しました。（2016-12-02)
...
ブログサイト「[市況かぶ全力２階建](http://kabumatome.doorblog.jp/)」さんの2016年中の記事に引用登場したTwitterアカウントのランキングを集計します。
...
- ２階建さんの2016年中の公開記事を対象にしています。（期間はconfig.phpにて定義）
