市況かぶ全力2階建さん 登場者ランキング2018
====================

【Update!】2018年に対応しました。（2018-12-22)
...
ブログサイト「[市況かぶ全力２階建](http://kabumatome.doorblog.jp/)」さんの2018年中の記事に引用登場したTwitterアカウントのランキングを集計します。
...
- ２階建さんの2018年中の公開記事を対象にしています。（期間はconfig.phpにて定義）
