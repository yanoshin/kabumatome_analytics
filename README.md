市況かぶ全力2階建さん 登場者ランキング2023
====================

【Update!】2023年に対応しました。（2023-12-13)
...
ブログサイト「[市況かぶ全力２階建](http://kabumatome.doorblog.jp/)」さんの2023年中の記事に引用登場したTwitterアカウントのランキングを集計します。
...
- ２階建さんの2023年中の公開記事を対象にしています。（期間はconfig.phpにて定義）
